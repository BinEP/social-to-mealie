  ...
  try {
    const { object } = await generateObject({
      ...
      prompt: `
        ...
        IMPORTANT: In the description field, include the original social media description and append the source URL at the end in the format "Original source: [URL]".
        Output must be valid JSON-LD Schema.org Recipe format.
        ${
